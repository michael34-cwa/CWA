...
export default combineReducers({ auth, user, course_categories, courses, tasks, school_lists, school_admin, school_courses, teachers, students, students_course, assign_course});
