...
//Application Title
define('APP_TITLE', 'CWA File Manager');
...
//echo  $root_path =  $root_path.'/'.$response->sudent;
...
if(empty($_SESSION[FM_SESSION_ID]['logged']) || $_GET['token'] != ''){
    ...
    curl_setopt_array($curl, array( 
      CURLOPT_URL => "http://127.0.0.1:8000/api/v1/auth/user",
      ...
      CURLOPT_HTTPHEADER => array(
        ...
        "postman-token: 1d2f224c-bbc6-60be-710c-a72c82dfc056"
      ),
    ));
    ...
    if ($err) {
      ...
      exit;
        ...
        $_SESSION[FM_SESSION_ID]['logged'] =$_GET['student']; 
     
    } 
    
    }
    $root_path = $root_path.'/'.$_SESSION[FM_SESSION_ID]['logged'];
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="https://github.com/prasathmani/tinyfilemanager" target="_blank" class="app-v-title"> CWA File Manager <?php echo VERSION; ?></a></h3></p>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">CWA File Manager <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">CWA File Manager <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
 ...
 class FM_Config
{
    ...
    function __construct()
    {
        ...
        if (strlen($CONFIG)) {
            ...
            $msg = 'CWA File Manager<br>Error: Cannot load configuration';
            if (substr($fm_url, -1) == '/') {
                $fm_url = rtrim($fm_url, '/');
                $msg .= '<br>';
...
<head>
    ...
    <meta name="description" content="CWA File Manager">
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'CWA File Manager';      $tr['en']['AppTitle']           = 'File Manager';
